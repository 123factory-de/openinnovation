...
- SAP BTP 기반 구축을 위한 기술 지원과 자문
- SAP 클라우드, AI, 분석 서비스와 연동해 데이터를 가치로 전환하는 활용 사례 구현

## 지원 방법

- 스타트업은 공식 SAP Business Technology Platform 페이지에서 프로그램 세부 사항을 확인하고 SAP BTP 기반 개발을 시작하는 방법을 알아본 뒤 지원할 수 있습니다.
